...
public class Test01 {
	...
	public Test01() {
			// 파일에 저장하기 위해서는 파일로 연결된 스트림이 필요한다.
			FileOutputStream fout = null;
			
			// 경로가 잘못되면 파일을 만들 수 없으므로 예외처리가 필요하다.
			try {
				fout = new FileOutputStream("C:\\class\\Java\\repo\\start\\start\\src\\day17\\result/FileTest01.txt");
			//	fout = new FileOutputStream("src/day17/result/FileTest01.txt");
				...
				*/
				...
				byte[] buff = song.getBytes();
				fout.write(buff, 9, buff.length - 9);	// buff.length - 9 : 내보낸ㄹ 개수, 9 : 시작 인덱스
