...
public class Test04 {
	...
	// Friend 배열 내용 출력해주는 함수
		public void toPrint() {
			...
			for(int i = 0; i < black.length; i++) {
				// 이때 배열의 각 방에 기억된 객체들의 멤버 변수는 접근이 불가능하므로
	...
	//		black[i] = f;	// 주소를 인덱스 위치의 내용과 변수가 공유하기때문에 의미가 없다.
	...
	public void setData() {
		...
		email = new String[] {"jenny@github.com", "lisa@github.com", "rose@github.com", "jisoo@github.com"};
