...
public class Test09 {
	...
	public Test09() {
		...
		MyThread01 my = new MyThread01(); // New Born 상태
		MyThread02 dog = new MyThread02();	// New Born 상태
...
/*
 	원래는 스레드 프로그램 역시 다른 파일에 클래스를 만들어아 하는데
...
class MyThread01 extends Thread {
	...
	@Override
	public void run() {
		// 나는 이 프로그램에서 내가 코딩을 1000개를 하도록 하게 할것이다.
